...
const staticInputs: StaticRouteInput[] = [
  { path: "", type: "home", title: "Inch is CM - Home Length Converter", description: "Inch is CM is the site home and main tool entry. Convert inches to centimeters or switch units, then open dedicated hubs, charts, and exact pages.", h1: "Inch is CM Length Converter", directAnswer: "1 inch equals exactly 2.54 centimeters.", formula: "inches × 2.54 = centimeters", category: "inch", searchIntent: "length converter home" },
  { path: "/inches-to-cm", type: "tool", title: "Inches to CM Converter - Dedicated Conversion Hub", description: "Dedicated inches-to-centimeters hub with the exact 2.54 formula, worked examples, chart links, and exact inch conversion pages.", h1: "Inches to CM Converter", directAnswer: "Enter an inch value to get its exact centimeter equivalent.", formula: "inches × 2.54 = centimeters", category: "inch", searchIntent: "inches to centimeters hub" },
  ...
  { path: "/height-converter", type: "tool", title: "Height Converter - Feet and Inches to CM", description: "Convert feet and inches to centimeters, or convert centimeters back to feet and inches with total inches, meters, and formula steps.", h1: "Height Converter - Feet and Inches to CM", directAnswer: "Convert feet and inches to centimeters, or centimeters to feet and inches.", formula: "(feet × 12 + inches) × 2.54 = centimeters", category: "height", searchIntent: "convert feet and inches height to centimeters" },
  { path: "/height-chart", type: "chart", title: "Height Chart - Feet and Inches to CM Table", description: "Compare heights from 4'0 through 7'0 in centimeters, with one-inch increments, exact values, and detailed height pages.", h1: "Feet and Inches to CM Height Chart", directAnswer: "The chart compares feet-and-inches heights with exact centimeter values.", formula: "total inches × 2.54 = centimeters", category: "height", searchIntent: "feet and inches height chart in centimeters" },
