...
export const metadata = pageMetadata("Screen Size Converter - Inches to CM", "Convert laptop, monitor, tablet, and TV screen diagonals from inches to centimeters and understand screen sizing.", "/screen-size-converter");
