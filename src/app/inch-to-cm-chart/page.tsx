...
export const metadata = pageMetadata("Inch to CM Chart - 1 to 100 Inches Table", "Search an inch to centimeter table from 1 to 100 inches with exact values and detailed conversion links.", "/inch-to-cm-chart");
